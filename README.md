...
A self-contained HTML catalogue: **Sacred Charms of Thailand — เครื่องราง**.
Standalone reference artifact (open in any browser).

- View: double-click **Open Reference.command** (or open `amulet-reference.html`)
